      ...
      >
        <div className="container z-index-common">
          <div className="breadcumb-content">
            <h1 className="breadcumb-title fs-4 fw-normal">Shop Details</h1>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="actions">
                  ...
                  <Link to="/cart" className="vs-btn fw-normal">
                        ...
                        <div className="vs-post-comment">
                          ...
                          <div className="comment-content">
                            <div className="comment-content__header">
                              ...
                              <h4 className="name h4 fw-normal">Crish Thomas</h4>
                            </div>
                            <p className="text fs-5">
                  ...
                  <div className="vs-comment-form review-form">
                    <div id="respond" className="comment-respond">
                      <div className="form-title">
                        <h3 className="blog-inner-title fw-normal">Add A Review</h3>
